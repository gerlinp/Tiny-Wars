...
import { MEASURED_CONTENT_FILL as FILL } from './MeasuredContentFill'
...
export const CARD_ASSET_BUNDLES: CardAssetBundle[] = [
  ...
  },
  {
    ...
    contentFill: FILL.skeleton_army,
    attackHitFrame: 4,
    tintBotSide: true,
    player: skullSide('blue'),
    bot:    skullSide('red'),
  ...
  },
  {
    ...
    contentFill: FILL.goblin_demolisher,
    attackHitFrame: 17,
  ...
  },
  {
    ...
    avatarCropRatio: 0.55,
    contentFill: FILL.harpoon_shark,
    attackHitFrame: 4,
    tintBotSide: true,
  ...
  },
  {
    ...
    contentFill: FILL.goblin_barrel,
